        ...
        child: Column(
          ...
          children: [
            ...
            Row(
              ...
              children: [
                IconButton(
                  icon: Icon(Icons.menu, color: Colors.black, size: 30.sp), // Usamos ScreenUtil para el tamaño del icono
                  onPressed: () {
                ...
                Text(
                  ...
                  style: TextStyle(
                    color: Colors.black,
                    fontSize: 20.sp, // Usamos ScreenUtil para el tamaño de la fuente
                    fontWeight: FontWeight.bold,
                  ),
                ),
              ],
            ),
            SizedBox(height: 30.h), // Usamos ScreenUtil para el espacio entre widgets
            ...
            Column(
              children: [
                Image.asset(
                  ...
                  height: 180.h,
                  width: 180.w, // Usamos ScreenUtil para el tamaño de la imagen
                ),
                Text(
                  'TRADUCTOR',
                  style: TextStyle(fontSize: 26.sp, color: const Color(0xFFF49F38)),
                ),
                Text(
                  'ComSeñas',
                  style: TextStyle(
            ...
            SizedBox(height: 50.h), // Usamos ScreenUtil para el tamaño de la separación
                  ...
                  children: [
                    _islanguageExchange
                        ? Image.asset(
                            ...
                            height: 100.h,
                            width: 100.w, // Usamos ScreenUtil para el tamaño
                          )
                        : Image.asset(
                    ...
                    Text(
                      ...
                      style: TextStyle(
                        color: Colors.black,
                        fontSize: 16.sp, // Usamos ScreenUtil para el tamaño de la fuente
                        fontWeight: FontWeight.w900,
                      ),
                    ),
                  ],
                ),
                SizedBox(width: 20.w), // Usamos ScreenUtil para el tamaño de separación
                IconButton(
                  icon: Icon(
                    Icons.swap_horiz,
                    color: Colors.white,
                    size: 40.sp, // Usamos ScreenUtil para el tamaño del icono
                  ),
            ...
            ElevatedButton(
              ...
              style: ElevatedButton.styleFrom(
                ...
                padding: EdgeInsets.symmetric(horizontal: 80.w, vertical: 15.h), // Usamos ScreenUtil para padding
              ...
              child: Text(
                'COMENZAR',
                style: TextStyle(
                  fontSize: 18.sp, // Usamos ScreenUtil para el tamaño de la fuente
                  fontWeight: FontWeight.bold,
                  color: Colors.white,
                ),
              ),
